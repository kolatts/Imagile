# Still having issue with the dev container not being able to communicate with the db
...
# for i in {1..60};
# do
#     /opt/mssql-tools/bin/sqlcmd -S localhost,1434 -U sa -P $SApassword -d master -Q "SELECT * FROM SYS.DATABASES" > /dev/null
#     if [ $? -eq 0 ]
#     then
